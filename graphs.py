...
for i in df.index:
    ...
    img_box.send_keys(
        "/home/surya/covid-wh_bot/Covid_bot_V1/data/%s/new_confirmed.jpg"
        % df["state"][i]
    )
    time.sleep(2)
    while 1:
    ...
    img_box.send_keys(
        "/home/surya/covid-wh_bot/Covid_bot_V1/data/%s/new_deceased.jpg"
        % df["state"][i]
    )
    time.sleep(0.5)
    while 1:
    ...
    img_box.send_keys(
        "/home/surya/covid-wh_bot/Covid_bot_V1/data/%s/new_recovered.jpg"
        % df["state"][i]
    )
    time.sleep(0.5)
    while 1:
    ...
    img_box.send_keys(
        "/home/surya/covid-wh_bot/Covid_bot_V1/data/india_new_confirmed.jpg"
    )
    time.sleep(0.5)
    while 1:
        try:
    ...
    img_box.send_keys(
        "/home/surya/covid-wh_bot/Covid_bot_V1/data/india_new_recovered.jpg"
    )
    time.sleep(0.5)
    while 1:
        try:
    ...
    img_box.send_keys(
        "/home/surya/covid-wh_bot/Covid_bot_V1/data/india_new_deceased.jpg"
    )
    time.sleep(0.5)
    while 1:
        try:
